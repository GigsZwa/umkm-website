<?php
/**
 * config.php - File konfigurasi utama UMKM
 * Edit bagian ini sesuai bisnis Anda
 */

// === PENGATURAN UMUM ===
define('SITE_NAME', 'Berkah Jaya');
define('SITE_DESC', 'UMKM terpercaya menyediakan produk berkualitas dan pelayanan ramah.');
define('WHATSAPP_NUMBER', '6281234567890'); // tanpa +, awali 62
define('MESSAGES_FILE', __DIR__ . '/data/messages.json'); // penyimpanan pesan kontak

// === DATA PRODUK ===
// Ganti gambar dengan foto produk asli di folder assets/images/
$products = [
    [
...
/**
 * =============================================
 * OPSIONAL: KONEKSI DATABASE MYSQL
 * =============================================
 * Hapus komentar di bawah jika ingin pakai MySQL,
 * lalu sesuaikan credential. Contoh tabel bisa
 * dilihat di file database.sql
 *
 * define('DB_HOST', 'localhost');
 * define('DB_USER', 'root');
 * define('DB_PASS', '');
 * define('DB_NAME', 'umkm_db');
 *
 * // Fungsi koneksi (pakai jika perlu)
 * function getDB() {
